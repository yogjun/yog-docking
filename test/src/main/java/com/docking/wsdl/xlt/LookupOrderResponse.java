...
/**
 * <p>lookupOrderResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="lookupOrderResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="error" type="{http://service.hop.service.ws.hlt.com/}HopHopError" minOccurs="0"/>
 *         &lt;element name="order" type="{http://service.hop.service.ws.hlt.com/}order" minOccurs="0"/>
...
@XmlType(name = "lookupOrderResponse", propOrder = {
    "error",
    "order",
    "success"
})
